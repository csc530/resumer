...
{
	protected static void PrintJobsPlain(T settings, Dictionary<long, Job> rows)
	{
	...
	protected static void PrintJobsTable(T settings, Table table, Dictionary<long, Job> rows)
	{
		InitializeSettings(settings);
		if(settings.Id)
