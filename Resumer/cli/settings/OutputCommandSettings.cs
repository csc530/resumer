...
public class OutputCommandSettings : CliSettings
{
    ...
    public Table? GetTable(IEnumerable<KeyValuePair<string, bool>> columns, string? title = null, string? caption = null)
    {
    ...
    public Table? GetTable(Type type, string? title = null, string? caption = null)
    {
        var table = GetTable(title, caption);
    ...
    public Table? GetTable(string? title = null, string? caption = null) =>
        Plain switch
        {
            ...
            true when Table => new Table()
            {
                ...
                Caption = caption == null ? null : new TableTitle(caption),
                Title = null,
                UseSafeBorder = true,
            },
            false => new Table
